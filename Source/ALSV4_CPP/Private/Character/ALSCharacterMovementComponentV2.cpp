...
UALSCharacterMovementComponentV2::UALSCharacterMovementComponentV2(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UALSCharacterMovementComponentV2::OnMovementUpdated(float DeltaTime, const FVector& OldLocation,
...
void UALSCharacterMovementComponentV2::PhysWalking(float deltaTime, int32 Iterations)
{
...
float UALSCharacterMovementComponentV2::GetMaxAcceleration() const
{
...
float UALSCharacterMovementComponentV2::GetMaxBrakingDeceleration() const
{
...
void UALSCharacterMovementComponentV2::UpdateFromCompressedFlags(uint8 Flags) // Client only
{
...
class FNetworkPredictionData_Client* UALSCharacterMovementComponentV2::GetPredictionData_Client() const
{
	check(PawnOwner != nullptr);

	if (!ClientPredictionData)
	{
		UALSCharacterMovementComponentV2* MutableThis = const_cast<UALSCharacterMovementComponentV2*>(this);
...
void UALSCharacterMovementComponentV2::FSavedMove_My::Clear()
{
	Super::Clear();
...
uint8 UALSCharacterMovementComponentV2::FSavedMove_My::GetCompressedFlags() const
{
...
void UALSCharacterMovementComponentV2::FSavedMove_My::SetMoveFor(ACharacter* Character, float InDeltaTime,
                                                               ...
                                                               ClientData)
{
	...
	UALSCharacterMovementComponentV2* CharacterMovement = Cast<UALSCharacterMovementComponentV2>(Character->GetCharacterMovement());
...
void UALSCharacterMovementComponentV2::FSavedMove_My::PrepMoveFor(ACharacter* Character)
{
...
UALSCharacterMovementComponentV2::FNetworkPredictionData_Client_My::FNetworkPredictionData_Client_My(
	const UCharacterMovementComponent& ClientMovement)
	: Super(ClientMovement)
{
}

FSavedMovePtr UALSCharacterMovementComponentV2::FNetworkPredictionData_Client_My::AllocateNewMove()
{
	return MakeShared<FSavedMove_My>();
}

void UALSCharacterMovementComponentV2::Server_SetAllowedGait_Implementation(const FGameplayTag NewAllowedGait)
{
	AllowedGait = NewAllowedGait;
}

float UALSCharacterMovementComponentV2::GetMappedSpeed() const
{
...
void UALSCharacterMovementComponentV2::SetMovementSettings(FALSMovementSettings NewMovementSettings)
{
...
void UALSCharacterMovementComponentV2::SetAllowedGait(FGameplayTag NewAllowedGait)
{
