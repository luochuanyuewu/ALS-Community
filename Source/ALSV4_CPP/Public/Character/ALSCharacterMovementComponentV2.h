...
#include "ALSCharacterMovementComponentV2.generated.h"
 ...
 */
UCLASS()
class ALSV4_CPP_API UALSCharacterMovementComponentV2 : public UCharacterMovementComponent
{
	...
	UFUNCTION(BlueprintCallable, Category = "Movement Settings")
	virtual void SetAllowedGait(FGameplayTag NewAllowedGait);
